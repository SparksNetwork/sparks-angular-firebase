...
file named `adminsdk.json` that will be placed in: `/functions/e2e/setup`. In order to obtain the file:
...
- rename the downloaded file to `adminsdk.json` and place it in `/functions/e2e/setup`
