...
export class ExploreStateService {
  ...
  public organizedProjectsIdx$ = this.userService.profileKey$
    .switchMap(profileKey => this.projectService.by('organizerProfileKey', profileKey))

  public organizedProjectKeys$ = this.organizedProjectsIdx$
    .map(idx => idx.keys || [])

  public organizedProjectsLength$ = this.organizedProjectKeys$
